package com.veyseltoprak.todolist.controller;

import com.veyseltoprak.todolist.model.*;
import com.veyseltoprak.todolist.repository.*;
import com.veyseltoprak.todolist.security.UserPrincipal;
...
public class TodoListController {
    ...
    public ResponseEntity<Iterable<TodoItem>> getItems(@PathVariable("id") Long id,
                                        Authentication authentication) {
        TodoList todoList = repository.findOneByIdAndOwner(id, getOwnerFromAuthentication(authentication));
        return new ResponseEntity<>(itemRepository.findAllByListAndOwner(todoList, getOwnerFromAuthentication(authentication)), HttpStatus.OK);
    }
